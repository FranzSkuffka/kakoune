= image:{logo}[K,30,30] Kakoune image:{travis-img}[link="{travis-url}"] [![Average time to resolve an issue](http://isitmaintained.com/badge/resolution/mawww/kakoune.svg)](http://isitmaintained.com/project/mawww/kakoune "Average time to resolve an issue") [![Percentage of issues still open](http://isitmaintained.com/badge/open/mawww/kakoune.svg)](http://isitmaintained.com/project/mawww/kakoune "Percentage of issues still open")
